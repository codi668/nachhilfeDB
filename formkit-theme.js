...
export default {
    ...
    'family:text': {
        inner: 'flex items-center max-w-md [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
        input: 'pl-3 block w-full rounded-md ring-black py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
    },
    'family:email': {
        inner: 'flex items-center max-w-md [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
        input: 'pl-3 block w-full rounded-md ring-black py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
